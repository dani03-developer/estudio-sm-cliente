...
const ServicesList = [
    {
        ...
        iconName: 'LuKeyRound',
        icon: <LuKeyRound />,
        img: 'https://i.postimg.cc/PqBvVZnr/Imagen-Detalle.jpg',
    ...
    },
    {
        ...
        description: 'Inscripción en el Régimen Simplificado o General de de cada dirección provincial de rentas según la jurisdicción, incluyendo Convenio Multilateral.',
    ...
    {
        //id: "5",
        iconName: 'HiOutlineDocumentSearch',
    ...
    {
        //id: "7",
        iconName: 'LiaMoneyCheckAltSolid',
        icon: <LiaMoneyCheckAltSolid />,
        img: 'https://i.postimg.cc/PqBvVZnr/Imagen-Detalle.jpg',
        type: 'Servicio Puntual',
        nameService: 'Planes de Facilidades de Pago',
        description: 'Confección y presentación de planes de regularización en ARCA o moratorias según cada jurisdicción provincial.',
    ...
    {
        //id: "10",
        iconName: 'MdOutlineAccountBalance',
